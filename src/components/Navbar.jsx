...
const Navbar = () => {
  ...
  return (
    <div className='flex justify-between items-center h-24 mx-auto max-w-[1240px] px-4 text-white'>
        ...
        <div className= {nav ? 'fixed left-0 top-0 w-[60%] h-full bg-black ease-in-out duration-500' : 'fixed left-[-100%]'}>
            <h1 className='w-full text-3xl font-bold text-[#00df9a] m-5'>Demo.</h1>
